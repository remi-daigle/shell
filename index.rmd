...
Please download the [data](https://github.com/remi-daigle/shell/archive/gh-pages.zip) folder if you want to follow along
...
In general, logging in can be down with 1 line (once you have a username and password):
~~~ {.bash}
$ ssh username@hpcname
~~~
